...
Revision ID: f2048b504892
Revises: 
Create Date: 2024-03-21 11:35:30.238532
...
def upgrade() -> None:
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('path_tranform', sa.String(length=250), nullable=False),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('opinion', sa.String(length=250), nullable=False),
